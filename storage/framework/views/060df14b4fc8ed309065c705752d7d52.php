      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <?php endif; ?> 
            <?php if(auth()->user()->level =='anggota'): ?>
            <?php echo $__env->make('template.sidebarAnggota', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?> 
          </ul>
          </li>
          </ul>
...
</html><?php /**PATH C:\Users\User\AplikasiPerpustakaan\resources\views/template/app.blade.php ENDPATH**/ ?>